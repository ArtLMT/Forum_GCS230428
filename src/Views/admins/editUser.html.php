...
<?php if (isset($user) && $user !== null) : ?>
    ...
    <form action="/forum/public/admin/updateUser" method="post" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <input 
                type="text" 
                name="username" 
                class="w-full px-4 py-1 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400" 
        ...
        <div>
            ...
            <input type="file" name="image" class="block w-full text-sm text-gray-500 file:mr-4 file:py-1 file:px-4 file:border-0 file:rounded-lg file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" />
        </div>
        ...
        <div class="text-center">
            <button 
                type="submit" 
                class="px-6 py-1 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition duration-200"
            >
                Update User
            </button>
        </div>
